        ...
        <section id="result" class="flex flex-col gap-4 px-4 mb-[111px] mt-[10px]">
            @forelse ($shoes as $itemShoe)
                <a href="{{ route('front.details', $itemShoe->slug) }}">
                    <div
                        class="flex items-center rounded-3xl p-[10px_16px_16px_10px] gap-[14px] bg-white transition-all">
                        <div class="w-20 h-20 flex shrink-0 rounded-2xl bg-[#0909D9] overflow-hidden">
