...
class OrderService
{
    ...
    public function getOrderDetails()
    {
        ...
        // ambil diskon dari session (kalau ada)
        $discount = $orderData['total_discount_amount'] ?? 0;

        // subtotal setelah diskon
        $afterDiscount = $subTotalAmount - $discount;

        $taxRate = 0.11;
        $totalTax = $afterDiscount * $taxRate;

        $grandTotalAmount = $afterDiscount + $totalTax;

        $orderData['sub_total_amount'] = $subTotalAmount;
        $orderData['total_discount_amount'] = $discount;
